const API_KEY_MOVIE = process.env.REACT_APP_API_KEY;


const API_URL = `https://api.themoviedb.org/3/movie/popular?api_key=${API_KEY_MOVIE}`;

// eslint-disable-next-line
const getMovie = (countPage) => API_URL + `&language=en-US&page=${countPage}`;
