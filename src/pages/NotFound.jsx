...
import poster from '../assets/images/error.svg';
import human from '../assets/images/human-error.svg';
...
const NotFound = () => {
	const {animationContent, animationImage} = useData();
				...
				<Body>
					<ImageBg>
						...
						<ImageBody variants={animationImage}>
							<img src={poster} alt="error-poster" />
						</ImageBody>
					</ImageBg>
					<Content>
						<Title variants={animationContent} custom={1}>
